      ...
      <>
        ...
        <section className="min-h-screen bg-bg-base flex items-center justify-center px-6">
          <div className="text-center animate-fade-in-up">
            ...
            <Link
              to="/services"
              className="bg-violet-600 hover:bg-violet-700 text-white px-8 py-3 rounded-2xl font-semibold transition-all"
            >
              Back to Services
            </Link>
          </div>
  ...
  return (
    <>
        ...
        <div className="container relative z-30 max-w-7xl mx-auto px-6 h-screen flex items-center pt-16 lg:pt-28">
          <div className="flex flex-wrap items-center gap-8 lg:gap-12 opacity-0 animate-fade-in-up" style={{ animationDelay: '900ms', animationFillMode: 'forwards' }}>
            ...
            <div className="shrink-0">
              <div className="group relative w-28 h-28 lg:w-36 lg:h-36 overflow-hidden rounded-3xl bg-white/10 backdrop-blur-md ring-4 ring-white/15 shadow-2xl shadow-violet-500/40 transition-all duration-500 flex items-center justify-center">
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                ...
                <svg className="w-3.5 h-3.5 text-white/25" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
              ...
              <div className="inline-flex items-center gap-2.5 bg-white/10 backdrop-blur-md text-white px-4 py-2 rounded-full text-xs font-medium mb-4 border border-white/15">
                <span className="w-2 h-2 bg-violet-300 rounded-full animate-pulse-subtle" />
                Medical Service
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-[1.1] mb-3">
                {service.title}
              </h1>
              <p className="text-lg text-white/75 max-w-xl">{service.tagline}</p>

              {/* Quick stats */}
              <div className="flex flex-wrap gap-4 mt-6">
                <div className="flex items-center gap-1.5 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 text-sm text-white/80 border border-white/10">
      ...
      <section className="py-16 lg:py-24 bg-bg-surface relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-violet-100/30 to-transparent rounded-full blur-[100px] pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-purple-100/20 to-transparent rounded-full blur-[80px] pointer-events-none" />
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-3 gap-10 lg:gap-14">
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <div className="animate-fade-in-up">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-slate-900">About This Service</h2>
                </div>
                <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-violet-100/60">
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {service.details?.map((detail) => (
                    <div key={detail} className="group flex items-start gap-3 bg-white/70 backdrop-blur-sm rounded-2xl p-4 border border-violet-100/60 hover:border-violet-200 hover:bg-white hover:shadow-lg hover:shadow-violet-500/5 transition-all duration-300">
                      <div className="w-8 h-8 bg-gradient-to-br from-violet-100 to-purple-100 rounded-xl flex items-center justify-center shrink-0 group-hover:from-violet-500 group-hover:to-purple-600 transition-all duration-300">
                        <svg className="w-4 h-4 text-violet-600 group-hover:text-white transition-colors duration-300" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h2 className="text-2xl font-bold text-slate-900">Why Choose Our {service.title}?</h2>
                </div>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.title} className="group flex items-start gap-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-violet-100/60 hover:bg-white hover:border-violet-200 hover:shadow-lg hover:shadow-violet-500/5 transition-all duration-300">
                      <div className="w-10 h-10 bg-gradient-to-br from-violet-100 to-purple-100 rounded-xl flex items-center justify-center shrink-0 mt-0.5 group-hover:from-violet-500 group-hover:to-purple-600 transition-all duration-300">
                        <svg className="w-5 h-5 text-violet-600 group-hover:text-white transition-colors duration-300" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                        </svg>
                      </div>
                      <div>
            ...
            <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '150ms' }}>
              {/* Pricing */}
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 border border-violet-100/60 shadow-lg shadow-violet-500/5">
                <div className="flex items-center gap-2 mb-5">
                  ...
                  <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wider">Pricing Plans</h3>
                </div>
                <div className="space-y-3">
                  {service.pricing.map((p) => (
                    <div key={p.plan} className="flex items-center justify-between bg-violet-50/50 rounded-2xl px-4 py-3 border border-violet-100/60 hover:border-violet-200 hover:bg-violet-50 transition-all duration-300">
                      <div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 border border-violet-100/60 shadow-lg shadow-violet-500/5">
                <div className="flex items-center gap-2 mb-5">
                  ...
                  <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wider">Our Specialists</h3>
                </div>
                <div className="space-y-3">
                  {service.doctors.map((doc) => (
                    <div key={doc} className="flex items-center gap-3 p-2 rounded-xl hover:bg-violet-50/50 transition-colors duration-300">
                      <div className="w-11 h-11 rounded-full bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm shrink-0 shadow-lg shadow-violet-500/25">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 border border-violet-100/60 shadow-lg shadow-violet-500/5">
                <div className="flex items-center gap-2 mb-5">
                  ...
                  <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wider">Quick Info</h3>
                </div>
              ...
              <Link
                to="/appointments"
                className="block w-full text-center bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white px-6 py-4 rounded-2xl font-semibold transition-all hover:shadow-2xl hover:shadow-violet-500/25 active:scale-[0.98]"
              >
        ...
        <div className="mt-16 animate-fade-in-up">
          <div className="relative overflow-hidden bg-gradient-to-br from-emerald-600 via-emerald-600 to-green-700 rounded-[2rem] shadow-2xl shadow-emerald-500/25">
            {/* Decorative elements */}
            ...
            <div className="absolute top-1/2 left-1/3 w-4 h-4 bg-white/10 rounded-full animate-float" />
            <div className="absolute top-1/4 right-1/4 w-3 h-3 bg-white/15 rounded-full animate-float-slow" />
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10 lg:gap-16 px-8 sm:px-12 lg:px-16 py-12 lg:py-14">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-white text-emerald-700 hover:bg-emerald-50 px-8 py-4 rounded-2xl font-bold text-lg transition-all hover:shadow-xl hover:shadow-emerald-900/20 active:scale-[0.97] group"
                >
              ...
              {/* Right: QR Code */}
              <div className="shrink-0">
                <div className="bg-white rounded-3xl p-5 shadow-xl shadow-emerald-900/20 text-center">
                  <img
                    ...
                    className="w-44 h-44 sm:w-48 sm:h-48 mx-auto rounded-2xl"
                    loading="lazy"
                  />
        ...
        <div className="flex justify-between mt-16 pt-8 border-t border-violet-200/60 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
          {prevService ? (
            <Link
              to="/services/$id"
              params={{ id: prevService.id }}
              className="flex items-center gap-3 text-slate-500 hover:text-violet-600 transition-colors group"
            >
